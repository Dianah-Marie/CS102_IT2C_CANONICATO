...
review_data <- dbGetQuery(connection, "SELECT * FROM canonicato_2c.reviews")
...
for (i in 1:nrow(reviews)) {
    query <- paste0("INSERT INTO reviews (movie_title, reviewer_name, reviewer_date, review_rating, review_content, review_title) 
                  VALUES ('", reviews$movie_title[i],"','", reviews$reviewer_name[i], "','", reviews$reviewer_date[i],"','", reviews$review_rating[i], "','",
...
# Export to csv
write.csv(review_data[,c(2:7)], "LabEx3.csv")
